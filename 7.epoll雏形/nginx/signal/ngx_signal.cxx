...
int ngx_init_signals()
{
    ...
    {        
        ...
        // 那咱们就可以用诸如sigaddset(&sa.sa_mask,SIGUSR2);
        // 这样的语句针对信号为SIGUSR1时做处理，这个sigaddset三章五节讲过；
        
        //这里.sa_mask是个信号集（描述信号的集合），用于表示要阻塞的信号，
...
static void ngx_process_get_status(void)
{
    ...
    for ( ;; ) 
    {
        //waitpid说白了获取子进程的终止状态，这样，子进程就不会成为僵尸进程了；
        //第一次waitpid返回一个> 0值，表示成功，
        // 后边显示 [alert] 3375: pid = 3377 exited on signal 9【SIGKILL】
